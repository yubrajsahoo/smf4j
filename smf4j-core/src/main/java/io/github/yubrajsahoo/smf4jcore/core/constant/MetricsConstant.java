...
package io.github.yubrajsahoo.smf4jcore.core.constant;
...
public final class MetricsConstant {
    ...
    /**
     * Default message prefix used by {@link MetricsLogger} when logging metrics.
     */
    public static final String DEFAULT_LOG_MESSAGE = "Metrics Logs For With->";

    /**
     * Default message prefix used by {@link MetricsLogger}
