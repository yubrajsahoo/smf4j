...
public abstract class MetricsService {
     ...
     */
    protected Tags evaluateTags(io.github.yubrajsahoo.smf4jcore.core.annotation.Tags[] tags,
                                StandardEvaluationContext context) {
        if (tags == null || tags.length == 0) {
            return Tags.empty();
        }
        List<Tag> tagList = new ArrayList<>(tags.length);
        for (io.github.yubrajsahoo.smf4jcore.core.annotation.Tags tag : tags) {
            if (tag != null) {
