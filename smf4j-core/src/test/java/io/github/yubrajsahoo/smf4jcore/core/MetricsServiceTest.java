...
class MetricsServiceTest {
    @Autowired
    CounterMetricsService counterMetricsService;

    @Autowired
    TimerMetricsService timerMetricsService;

    @Autowired
    GaugeMetricsService gaugeMetricsService;
    ...
    void testStart() {
        ...
        when(timerMock.enable()).thenReturn(true);
        io.micrometer.core.instrument.Timer.Sample start = timerMetricsService.start(timerMock);
        assertNotNull(start);
    }
    ...
    void testRecordMetrics_Counter_Null() {
        counterMetricsService.recordCounter(null, buildContext(null, null));
    ...
    void testRecordMetrics_Counter_Disabled() {
        ...
        counterMetricsService.recordCounter(counter, buildContext(null, null));
    ...
    void testRecordMetrics_Counter_Enabled() {
        ...
        counterMetricsService.recordCounter(counter, buildContext("GET", null));
    ...
    void testRecordMetrics_Counter_Enabled_WithError() {
        ...
        counterMetricsService.recordCounter(counter, buildContext(null, new RuntimeException("Test Exception")));
    ...
    void testRecordMetrics_Sample_Null() {
        ...
        timerMetricsService.recordTimer((io.micrometer.core.instrument.Timer.Sample) null, timer,
    ...
    void testRecordMetrics_Timer_Null() {
        timerMetricsService.recordTimer(mock(io.micrometer.core.instrument.Timer.Sample.class), null,
                buildContext(null, null)
        );
    ...
    void testRecordMetrics_Timer_Disabled() {
        Timer timerMock = mock(Timer.class);
        when(timerMock.enable()).thenReturn(true);
        io.micrometer.core.instrument.Timer.Sample sample = timerMetricsService.start(timerMock);
        ...
        timerMetricsService.recordTimer(sample, timer, buildContext(null, null));
    ...
    void testRecordMetrics_Counter_Exception() {
        ...
        assertDoesNotThrow(() -> counterMetricsService.recordCounter(counter, buildContext(null, null)));
    }
    ...
    void testRecordMetrics_Timer_Enabled() {
        ...
        timerMetricsService.recordTimer(sample, timer, buildContext("GET", null));
    ...
    void testRecordMetrics_Timer_Enabled_WithError() {
        ...
        timerMetricsService.recordTimer(sample, timer, buildContext(null, new RuntimeException("Test Exception")));
    ...
    void testRecordMetrics_Timer_Exception() {
        ...
        assertDoesNotThrow(() -> timerMetricsService.recordTimer(sample, timer, buildContext(null, null)));
    }

    @Test
    @DisplayName("Should Not Store Any Gauge Metrics Due to Gauge Null")
    void testRecordMetrics_Gauge_Null() {
        gaugeMetricsService.recordGauge(null, new Object(), obj -> 1.0, buildContext(null, null));
    ...
    void testRecordMetrics_Gauge_Disabled() {
        ...
        when(gauge.tags()).thenReturn(new Tags[0]);

        gaugeMetricsService.recordGauge(gauge, new Object(), obj -> 1.0, buildContext(null, null));
    ...
    void testRecordMetrics_Gauge_Enabled() {
        ...
        gaugeMetricsService.recordGauge(gauge, testObj, obj -> 42.0, buildContext(null, null));
    ...
    void testRecordMetrics_Gauge_Exception() {
        ...
        assertDoesNotThrow(() -> gaugeMetricsService.recordGauge(gauge, new Object(), obj -> 1.0, buildContext(null, null)));
    }
