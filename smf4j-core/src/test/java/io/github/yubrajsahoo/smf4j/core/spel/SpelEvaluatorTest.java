...
class SpelEvaluatorTest {
    ...
    void testEvaluate_Spel_Result_Object() {
        CounterMetrics result = JsonConverter.fromJsonFile(
        ...
        // The mock counter metric sets increment to 5.0
        assertEquals("5.0", parsedExpression);
    }

    @Test
    @DisplayName("testEvaluate with SpEL expression with error object")
